...
class TxRfFuncConfig:
    ...
    def check_carrier_combin_availible(self, ):
        pass
    ...
    def gen_carrier_combination(self):
        ...
        self.max_num_carrier = worksheet_in.cell(row=3, column=2).value
        ...
        for row in range(offset, max_row+1):
            ...
            carrier_dict['carrier_FB'] = int(worksheet_in.cell(row=row, column=5).value)
...
if __name__ == '__main__':
    tx_rf_func: TxRfFuncConfig = TxRfFuncConfig('D:\RuPyTest_P1A03\OperateString\TestDefGeneration\TX_RF_FUNC\TxRfFunc_Config_V1.xlsx')
