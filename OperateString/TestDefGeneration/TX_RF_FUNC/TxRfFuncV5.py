...
class TxRfFuncConfig:
    ...
    def gen_carrier_combination(self):
        ...
        freq_m = (self.freq_l + self.freq_h)/2
        ...
        if self.close_carrier=='False':
            self.close_carrier=False
        ...
        for i1 in range(len(carrier_setup)):
            ...
            current_row += 1
            worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_h-bw/2)
            current_row += 2
        ...
        for i1 in range(len(carrier_setup)):
            ...
            for i2 in range(len(carrier_setup)):
                ...
                carrier_comb = [carrier_setup[i1],carrier_setup[i2]]
                if i2 >= i1 and self.check_carrier_combin_availible(carrier_comb):
                    ...
                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_l+bw1/2)
                    current_col += 1
                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_h-bw2/2)
                    current_col = 2
                    current_row += 1
                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_h-bw1/2)
                    current_col += 1
                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_l+bw2/2)
                    current_col = 2
                    current_row += 1
                    if self.close_carrier and bw1+bw2+self.close_gap<self.full_bw:
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+self.close_gap)/2+bw1/2)
                        current_col += 1
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m+(bw1+bw2+self.close_gap)/2-bw2/2)
                        current_col = 2
                        current_row += 1
        ...
        for i1 in range(len(carrier_setup_narrow)):
            ...
            for i2 in range(len(carrier_setup_narrow)):
                ...
                carrier_comb = [carrier_setup_narrow[i1],carrier_setup_narrow[i2]]
                if i2 >= i1 and self.check_carrier_combin_availible(carrier_comb):
                    worksheet_out.cell(row=current_row, column=1).value = '*'
        ...
        for i1 in range(len(carrier_setup_narrow)):
            ...
            for i2 in range(len(carrier_setup)):
                bw2 = carrier_setup[i2]['carrier_bw']
                carrier_comb = [carrier_setup_narrow[i1],carrier_setup[i2]]
                if i2 >= i1 and self.check_carrier_combin_availible(carrier_comb):
                    worksheet_out.cell(row=current_row, column=1).value = '*'
        ...
        for i1 in range(len(carrier_setup)):
            ...
            for i2 in range(len(carrier_setup)):
                ...
                for i3 in range(len(carrier_setup)):
                    ...
                    index=[i1, i2, i3]
                    carrier_comb = [carrier_setup[i1], carrier_setup[i2],carrier_setup[i3]]
                    if i2 >= i1 and i3 >=i2 and self.check_carrier_combin_availible(carrier_comb):
                        worksheet_out.cell(row=current_row, column=1).value = '*'
                        worksheet_out.cell(row=current_row, column=2).value = '{} {} {} {} {} {} {} {} {}'.format(
                        ...
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_l + bw1 / 2)
                        current_col += 1
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format((self.freq_l + bw1 + self.freq_h - bw3)/2)
                        current_col += 1
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_h - bw3 / 2)
                        current_col = 2
                        current_row += 1
                        if self.close_carrier and bw1+bw2+bw3+self.close_gap*2<self.full_bw:
                        # 3 close carriers
                            worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+self.close_gap*2)/2+bw1/2)
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+self.close_gap*2)/2+bw1+self.close_gap+bw2/2)
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+self.close_gap*2)/2+bw1+self.close_gap+bw2+self.close_gap+bw3/2)
                            current_col = 2
                            current_row += 1
        ...
        for i1 in range(len(carrier_setup_narrow)):
            ...
            for i2 in range(len(carrier_setup)):
                ...
                for i3 in range(len(carrier_setup)):
                    ...
                    index = [i1, i2, i3]
                    carrier_comb = [carrier_setup_narrow[i1], carrier_setup[i2],carrier_setup[i3]]
                    if i2 >= i1 and i3 >=i2 and self.check_carrier_combin_availible(carrier_comb):
                        worksheet_out.cell(row=current_row, column=1).value = '*'
                        worksheet_out.cell(row=current_row, column=2).value = '{} {} {} {} {} {} {} {} {}'.format(
        ...
        for i1 in range(len(carrier_setup_narrow)):
            ...
            for i2 in range(len(carrier_setup_narrow)):
                ...
                for i3 in range(len(carrier_setup)):
                    bw3 = carrier_setup[i3]['carrier_bw']
                    index = [i1, i2, i3]
                    carrier_comb = [carrier_setup_narrow[i1], carrier_setup_narrow[i2],carrier_setup[i3]]
                    if i2 >= i1 and i3 >=i2 and self.check_carrier_combin_availible(carrier_comb):
                        worksheet_out.cell(row=current_row, column=1).value = '*'
                        worksheet_out.cell(row=current_row, column=2).value = '{} {} {} {} {} {} {} {} {}'.format(
                        ...
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_l + bw1 / 2)
                        current_col += 1
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format((self.freq_l + bw1 + bw2/2))
                        current_col += 1
                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(self.freq_h - bw3 / 2)
                        current_col = 2
                        current_row += 1
            ...
            for i2 in range(len(carrier_setup)):
                ...
                for i3 in range(len(carrier_setup)):
                    ...
                    for i4 in range(len(carrier_setup)):
                        ...
                        index=[i1, i2, i3,i4]
                        carrier_comb = [carrier_setup[i1], carrier_setup[i2], carrier_setup[i3],carrier_setup[i4]]
                        if i2 >= i1 and i3 >=i2 and i4>=i3 and self.check_carrier_combin_availible(carrier_comb):
                            worksheet_out.cell(row=current_row, column=1).value = '*'
                            worksheet_out.cell(row=current_row, column=2).value = '{} {} {} {} {} {} {} {} {} {} {} {}'.format(
                            ...
                            current_row += 1
                            #4 seperate carriers
                            freq_gap = (self.full_bw - bw1-bw2-bw3-bw4)/3
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 / 2)
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 + freq_gap + bw2/2)
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format((self.freq_h - bw4 - freq_gap - bw3/2))
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_h - bw4/2)
                            current_col = 2
                            current_row += 1

                            # 4 close carriers
                            if self.close_carrier and bw1 + bw2 + bw3 + bw4 + self.close_gap * 3 < self.full_bw:
                                worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+self.close_gap * 3)/2+bw1/2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+self.close_gap * 3)/2+self.close_gap+bw1+bw2/2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+self.close_gap * 3)/2+self.close_gap*2+bw1+bw2 + bw3/2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+self.close_gap * 3)/2+self.close_gap*3+bw1+bw2+bw3 + bw4/2)
                                current_col = 2
                                current_row += 1
            ...
            for i2 in range(len(carrier_setup)):
                ...
                for i3 in range(len(carrier_setup)):
                    ...
                    for i4 in range(len(carrier_setup)):
                        bw4 = carrier_setup[i4]['carrier_bw']
                        index=[i1, i2, i3,i4]
                        carrier_comb = [carrier_setup_narrow[i1], carrier_setup[i2], carrier_setup[i3],carrier_setup[i4]]
                        if i2 >= i1 and i3 >=i2 and i4>=i3 and self.check_carrier_combin_availible(carrier_comb):
                            worksheet_out.cell(row=current_row, column=1).value = '*'
                            worksheet_out.cell(row=current_row, column=2).value = '{} {} {} {} {} {} {} {} {} {} {} {}'.format(
            ...
            for i2 in range(len(carrier_setup_narrow)):
                ...
                for i3 in range(len(carrier_setup)):
                    ...
                    for i4 in range(len(carrier_setup)):
                        bw4 = carrier_setup[i4]['carrier_bw']
                        index = [i1, i2, i3, i4]
                        carrier_comb = [carrier_setup_narrow[i1], carrier_setup_narrow[i2], carrier_setup[i3],carrier_setup[i4]]
                        if i2 >= i1 and i3 >=i2 and i4>=i3 and self.check_carrier_combin_availible(carrier_comb):
                            worksheet_out.cell(row=current_row, column=1).value = '*'
                            ...
                            current_row += 1
                            # 4 seperate carriers
                            freq_gap = (self.full_bw - bw1 - bw2 - bw3 - bw4) / 2
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(
                                self.freq_l + bw1 / 2)
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(
                                self.freq_l + bw1 + bw2 / 2)
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(
                                self.freq_l + bw1 + bw2 + freq_gap)
                            current_col += 1
                            worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(
                                self.freq_h - bw4 / 2)
                            current_col = 2
                ...
                for i3 in range(len(carrier_setup)):
                    ...
                    for i4 in range(len(carrier_setup)):
                        ...
                        for i5 in range(len(carrier_setup)):
                            ...
                            carrier_comb = [carrier_setup[i1], carrier_setup[i2], carrier_setup[i3],
                                            carrier_setup[i4],carrier_setup[i5]]
                            if i2 >= i1 and i3 >=i2 and i4>=i3 and i5>=i4 and self.check_carrier_combin_availible(carrier_comb):
                                worksheet_out.cell(row=current_row, column=1).value = '*'
                                worksheet_out.cell(row=current_row, column=2).value = '{} {} {} {} {} {} {} {} {} {} {} {} {} {} {}'.format(
                                ...
                                current_row += 1
                                #5 seperate carriers
                                freq_gap = (self.full_bw - bw1-bw2-bw3-bw4)/4
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 / 2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 + freq_gap + bw2/2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 + freq_gap + bw2 + freq_gap + bw3/2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format((self.freq_h - bw5 - freq_gap - bw4/2))
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_h - bw5/2)
                                current_col = 2
                                current_row += 1

                                # 4 close carriers
                                if self.close_carrier and bw1 + bw2 + bw3 + bw4 +bw5 + self.close_gap * 4 < self.full_bw:
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+ self.close_gap * 4)/2+bw1/2)
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+ self.close_gap * 4)/2+self.close_gap+bw1+bw2/2)
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+ self.close_gap * 4)/2+self.close_gap*2+bw1+bw2 + bw3/2)
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+ self.close_gap * 4)/2+self.close_gap*3+bw1+bw2+bw3 + bw4/2)
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+ self.close_gap * 4)/2+self.close_gap*4+bw1+bw2+bw3+bw4+bw5/2)
                                    current_col = 2
                                    current_row += 1
                    ...
                    for i4 in range(len(carrier_setup)):
                        ...
                        for i5 in range(len(carrier_setup)):
                            ...
                            if i2 >= i1 and i3 >=i2 and i4>=i3 and i5>=i4 and self.check_carrier_combin_availible(carrier_comb):
                                ...
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 / 2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 + bw2/2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 + bw2 + freq_gap + bw3/2)
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format((self.freq_h - bw5 - freq_gap - bw4/2))
                                current_col += 1
                                worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_h - bw5/2)
                    ...
                    for i4 in range(len(carrier_setup)):
                        ...
                        for i5 in range(len(carrier_setup)):
                            ...
                            for i6 in range(len(carrier_setup)):
                                ...
                                carrier_comb = [carrier_setup[i1], carrier_setup[i2], carrier_setup[i3],
                                                carrier_setup[i4], carrier_setup[i5],carrier_setup[i6]]
                                if i2 >= i1 and i3 >=i2 and i4>=i3 and i5>=i4 and i6>=i5 and self.check_carrier_combin_availible(
                                    ...
                                    current_row += 1
                                    #6 seperate carriers
                                    freq_gap = (self.full_bw - bw1-bw2-bw3-bw4)/5
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 / 2)
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 + freq_gap + bw2/2)
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_l + bw1 + freq_gap + bw2 + freq_gap + bw3/2)
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format((self.freq_h - bw6 - freq_gap - bw5 - freq_gap - bw4/2))
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format((self.freq_h - bw6 - freq_gap - bw5/2))
                                    current_col += 1
                                    worksheet_out.cell(row=current_row, column=current_col).value = '{:.2f}M'.format(self.freq_h - bw6/2)
                                    current_col = 2
                                    current_row += 1

                                    # 6 close carriers
                                    if self.close_carrier and bw1 + bw2 + bw3 + bw4 + bw5 +bw6 + self.close_gap * 5 < self.full_bw:
                                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+bw6+ self.close_gap * 5)/2+bw1/2)
                                        current_col += 1
                                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+bw6+ self.close_gap * 5)/2+ self.close_gap +bw1+bw2/2)
                                        current_col += 1
                                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+bw6+ self.close_gap * 5)/2+ self.close_gap*2+bw1+bw2 + bw3/2)
                                        current_col += 1
                                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+bw6+ self.close_gap * 5)/2+ self.close_gap*3+bw1+bw2+bw3 + bw4/2)
                                        current_col += 1
                                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+bw6+ self.close_gap * 5)/2+ self.close_gap*4+bw1+bw2+bw3+bw4+bw5/2)
                                        current_col += 1
                                        worksheet_out.cell(row=current_row, column=current_col).value = '{}M'.format(freq_m-(bw1+bw2+bw3+bw4+bw5+bw6+ self.close_gap * 5)/2+ self.close_gap*5+bw1+bw2+bw3+bw4+bw5+bw6/2)
                                        current_col = 2
                                        current_row += 1
...
if __name__ == '__main__':
    tx_rf_func: TxRfFuncConfig = TxRfFuncConfig('D:\RuPyTest_P1A03\OperateString\TestDefGeneration\TX_RF_FUNC\TxRfFunc_Config_4417R1BRegression.xlsx')
